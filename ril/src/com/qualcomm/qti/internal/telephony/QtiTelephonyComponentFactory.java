...
import com.qualcomm.qti.internal.telephony.ExtTelephonyServiceImpl;
...
public class QtiTelephonyComponentFactory extends TelephonyComponentFactory {
    ...
    public void makeExtTelephonyClasses(Context context,
        ...
        try {
            ExtTelephonyServiceImpl.init(context, phones, commandsInterfaces);
        } catch (NoClassDefFoundError e) {
            Rlog.e(LOG_TAG, "Error creating ExtTelephonyServiceImpl", e);
        }
    }
}
