...
# Permissions
PRODUCT_COPY_FILES += \
    external/ant-wireless/antradio-library/com.dsi.ant.antradio_library.xml:$(TARGET_OUT_VENDOR)/etc/permissions/com.dsi.ant.antradio_library.xml \
    frameworks/native/data/etc/android.hardware.audio.low_latency.xml:$(TARGET_OUT_VENDOR)/etc/permissions/android.hardware.audio.low_latency.xml \
    ...
    frameworks/native/data/etc/android.hardware.sensor.barometer.xml:$(TARGET_OUT_VENDOR)/etc/permissions/android.hardware.sensor.barometer.xml \
    frameworks/native/data/etc/android.hardware.sensor.compass.xml:$(TARGET_OUT_VENDOR)/etc/permissions/android.hardware.compass.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/audio_policy_configuration.xml:$(TARGET_OUT_VENDOR)/etc/audio_policy_configuration.xml \
    $(LOCAL_PATH)/audio/mixer_paths.xml:$(TARGET_OUT_VENDOR)/etc/mixer_paths.xml

PRODUCT_COPY_FILES += \
    frameworks/av/services/audiopolicy/config/a2dp_audio_policy_configuration.xml:$(TARGET_OUT_VENDOR)/etc/a2dp_audio_policy_configuration.xml \
    frameworks/av/services/audiopolicy/config/audio_policy_volumes.xml:$(TARGET_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    frameworks/av/services/audiopolicy/config/default_volume_tables.xml:$(TARGET_OUT_VENDOR)/etc/default_volume_tables.xml \
    frameworks/av/services/audiopolicy/config/r_submix_audio_policy_configuration.xml:$(TARGET_OUT_VENDOR)/etc/r_submix_audio_policy_configuration.xml \
    frameworks/av/services/audiopolicy/config/usb_audio_policy_configuration.xml:$(TARGET_OUT_VENDOR)/etc/usb_audio_policy_configuration.xml
...
# IPC router config
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/sec_config:$(TARGET_OUT_VENDOR)/etc/sec_config

# Input device config
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/idc/projector_input.idc:$(TARGET_OUT_VENDOR)/usr/idc/projector_input.idc \
    $(LOCAL_PATH)/idc/synaptics-rmi-touchscreen.idc:$(TARGET_OUT_VENDOR)/usr/idc/synaptics-rmi-touchscreen.idc

# Keylayouts
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/keylayout/keypad_8974.kl:$(TARGET_OUT_VENDOR)/usr/keylayout/keypad_8974.kl \
    $(LOCAL_PATH)/keylayout/projector-Keypad.kl:$(TARGET_OUT_VENDOR)/usr/keylayout/projector-Keypad.kl \
    $(LOCAL_PATH)/keylayout/synaptics-rmi-touchscreen.kl:$(TARGET_OUT_VENDOR)/usr/keylayout/synaptics-rmi-touchscreen.kl \
    $(LOCAL_PATH)/keylayout/AK8789_HALL_SENSOR.kl:$(TARGET_OUT_VENDOR)/usr/keylayout/AK8789_HALL_SENSOR.kl
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media_profiles_V1_0.xml:$(TARGET_OUT_VENDOR)/etc/media_profiles_V1_0.xml
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermanager.xml:$(TARGET_OUT_VENDOR)/etc/thermanager.xml
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/wifi/WCNSS_cfg.dat:$(TARGET_OUT_VENDOR)/firmware/wlan/prima/WCNSS_cfg.dat \
    $(LOCAL_PATH)/wifi/WCNSS_qcom_cfg.ini:$(TARGET_OUT_VENDOR)/etc/wifi/WCNSS_qcom_cfg.ini \
